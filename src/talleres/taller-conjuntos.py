...
unico_matematicas = estudiantes_matematicas - estudiantes_fisica - estudiantes_programacion
unico_fisica = estudiantes_fisica - estudiantes_matematicas - estudiantes_programacion
unico_programacion = estudiantes_programacion - estudiantes_matematicas - estudiantes_fisica

# Unir los tres conjuntos de estudiantes que solo cursan una asignatura
# Escribe aquí tu código
solo_una_asignatura = unico_matematicas | unico_fisica | unico_programacion
